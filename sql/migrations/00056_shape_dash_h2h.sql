-- Shape Dash Marathon — H2H score polling (game_key shape-dash ↔ minigame_scores.game_type shape_dash).
...
comment on function public.h2h_tap_dash_scores_for_match(uuid) is
  'H2H skill contest: latest validated minigame_scores for both players (includes shape-dash → shape_dash).';
