-- Extend H2H skill score polling to all open minigames (game_key → minigame_scores.game_type).
...
comment on function public.h2h_tap_dash_scores_for_match(uuid) is
  'H2H skill contest: latest validated minigame_scores for both players (tap-dash, tile-clash, ball-run, dash-duel, turbo-arena).';
