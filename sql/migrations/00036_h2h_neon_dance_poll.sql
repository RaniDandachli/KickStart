-- Neon Dance H2H: extend score polling RPC (game_key neon-dance → minigame_scores.game_type neon_dance).
...
comment on function public.h2h_tap_dash_scores_for_match(uuid) is
  'H2H skill contest: latest validated minigame_scores for both players (includes neon-dance → neon_dance).';
