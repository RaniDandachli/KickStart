...
export const ZONE_THEMES = [
  ...
  // Zone 3 — "Pulse Inferno" — GD Dry Out: deep teal/cyan with hot accents
  {
    name: 'Pulse Inferno',
    sky: '#001e2e',
    skyMid: '#00263a',
    bgRect0: 'rgba(0,180,255,0.05)',
    bgRect1: 'rgba(0,180,255,0.09)',
    bgRect2: 'rgba(0,180,255,0.13)',
    ground: '#001018',
    groundLine: '#00ccff',
    groundGrid: 'rgba(0,200,255,0.22)',
    wallFill: '#001828',
    wallBorder: '#00ccff',
    wallGrid: 'rgba(0,200,255,0.18)',
    wallStripe: 'rgba(120,230,255,0.85)',
    spikeFill0: '#00eeff',
    spikeFill1: '#005588',
    spikeStroke: 'rgba(160,240,255,0.95)',
    voidFill: '#00080e',
    voidLine: 'rgba(0,180,255,0.6)',
    playerOuter: '#39e600',
    playerMid: '#1a9900',
    playerInner: '#00ccff',
    playerGlow: '#39e600',
    playerBorder: '#ffffff',
    gridLine: 'rgba(0,180,255,0.05)',
    ringBorder: '#ffffff',
    ringFill: 'transparent',
    diamondColor: 'rgba(0,200,255,0.18)',
    accentColor: '#00ccff',
  },
] as const;
