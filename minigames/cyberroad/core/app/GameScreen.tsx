...
class Game extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      score: 0,
      viewKey: 0,
      gameState: props.h2hSkillContest ? State.Game.playing : State.Game.none,
      showSettings: false,
  ...
  UNSAFE_componentWillMount() {
    ...
    this.engine.onGameReady = () => {
      ...
      if (this.props.h2hSkillContest) {
        this.engine._hero.stopIdle();
        this.onSwipe(swipeDirections.SWIPE_UP);
      }
    };
    this.engine.onGameEnded = () => {
      if (this.props.onH2hRunComplete) {
        this.props.onH2hRunComplete(this.engine.getH2hRunStats());
      }
  ...
  renderGameOver = () => {
    if (this.props.h2hSuppressGameOver) {
      return null;
    }
    ...
    return (
      <View
        ...
        style={[
          ...
          { flex: 1, backgroundColor: CyberRoadUi.bgRoot },
          Platform.select({
            web: { position: "fixed" },
        ...
        {isPaused && (
          <View
            style={[
              StyleSheet.absoluteFill,
              {
                backgroundColor: CyberRoadUi.scrim,
